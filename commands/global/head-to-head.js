...
const PLAYER_NAME_FONT = "700 60px Lexend";
const PLAYER_MMR_FONT = "500 45px Lexend";
const STATS_VALUE_FONT = "700 70px Lexend";
const STATS_LABEL_FONT = "500 32px Lexend";
const RECORD_VALUE_FONT = "700 80px Lexend";
const RECORD_LABEL_FONT = "500 48px Lexend";
const RECORD_SUBTITLE_FONT = "400 34px Lexend";
const HIGHLIGHT_TITLE_FONT = "600 36px Lexend";
const HIGHLIGHT_DESCRIPTOR_FONT = "400 26px Lexend";
const HIGHLIGHT_SUMMARY_FONT = "500 35px Lexend";
